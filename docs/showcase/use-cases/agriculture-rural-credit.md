...
**Authority-backed journey (21 September) — filmed.** The same two authorities, plus the
part the Authority Service added: a **live status check** on every presentation, so the
same unchanged credential is accepted, refused once its source record is suspended,
