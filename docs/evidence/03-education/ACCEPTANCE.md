...
| Automated positive, negative, privacy, trust, algorithm, holder, tampering, replay and percentage-boundary tests | **U** 175 passed, including 54 in the three Education-specific files plus shared coverage · **E** 150 passed, of which 52 are Education | MET |
